  ...
  return (
    <div className={classes.root}>
      ...
      <Typography gutterBottom className={classes.description}>
        ...
        , specially when you combine technology and human behaviours. I like to
        design the way people and technology interact improving their daily
        experiences. I'm such a inquisitive and friendly person that wants to
        help people by collecting ideas from everything around me, understanding
        ...
        and willness to help people get their goals. I have a background in
